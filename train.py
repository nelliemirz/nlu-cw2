...
def main(args):
    ...
    for epoch in range(last_epoch + 1, args.max_epoch):
        ...
        for i, sample in enumerate(progress_bar):
            ...
            In the forward step, the activations of all the different layers
            in the system are computed batch-wise. Then, the loss is computed
            and back-propagated and gradients are clipped. The weights are
            updated and the gradients are reset to zero.
            '''
